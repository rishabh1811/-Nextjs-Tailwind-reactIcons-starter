  ...
  <div className=" p-6 space-y-4">
    ...
    <h2 className="text-3xl underline underline-offset-4">Features</h2>
      <ul className="text-lg">
        <li className="flex items-center gap-x-2"><SiNextdotjs className='text-black' /> Next.js 12.0.8</li>
        <li className="flex items-center gap-x-2"><SiTailwindcss className='text-blue-600' /> Tailwind 3.0.16</li>
